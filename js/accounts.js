 ...
 *   refreshAccountsPage()              — re-fetches and re-renders (called on navigation)
...
// Module-level pointer assigned during init — called on every navigation
let _refreshFn = null;
export function refreshAccountsPage() {
...
export async function initAccountsPage(_uid) {
  ...
  const addForm    = document.getElementById("acct-add-form");
  const addErrEl   = document.getElementById("acct-add-error");
  const nameInput  = document.getElementById("acct-add-name");
  const typeInput  = document.getElementById("acct-add-type");
  const instInput  = document.getElementById("acct-add-institution");
  const cancelBtn  = document.getElementById("acct-add-cancel");
  const saveBtn    = document.getElementById("acct-add-save");
  ...
  // Expose refresh for hashchange navigation
  _refreshFn = refresh;
